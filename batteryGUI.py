...
but_dark = Button(gui, text='Dark', command=lambda:gui.configure(bg='dimgrey')).grid(row=2,column=0)
but_light = Button(gui, text='Light', command=lambda:gui.configure(bg='white')).grid(row=2,column=1)
