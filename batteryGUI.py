...
label_life = Label(gui, text='Percentage:', fg="black", font="none 16 bold underline").grid(row=0,column=0, sticky=W)
...
def darkMode():
    ...
    percent_dark=Label(gui, text='Percentage:', fg='white', bg='dimgrey',font="none 16 bold underline").grid(row=0,column=0, sticky=W)
    time_dark = Label(gui, text='Time Remaining:', fg="white", bg="dimgrey", font="none 16 bold underline").grid(row=1,column=0,sticky=W)

def filler_wht():
    fillWhite=Label(gui, bg='white').grid(row=2, column=0, pady=140)
    percent_light = Label(gui, text='Percentage:', fg='black', bg='white', font="none 16 bold underline").grid(row=0,column=0,sticky=W)
    time_light = Label(gui, text='Time Remaining:', fg="black", bg="white", font="none 16 bold underline").grid(row=1,column=0,sticky=W)

but_dark = Button(gui, text='Dark', command=lambda:[gui.configure(bg='dimgrey'),darkMode()]).grid(row=3,column=0)
